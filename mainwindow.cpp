...
MainWindow::MainWindow(QWidget *parent): QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    connect(ui->pushButton_17, SIGNAL(clicked()), this, SLOT(Tsyfry()));
    connect(ui->pushButton_18, SIGNAL(clicked()), this, SLOT(Tsyfry()));
    connect(ui->pushButton_19, SIGNAL(clicked()), this, SLOT(Tsyfry()));

    connect(ui->pushButton_14, SIGNAL(clicked()), this, SLOT(Tsyfry()));
    connect(ui->pushButton_15, SIGNAL(clicked()), this, SLOT(Tsyfry()));
    connect(ui->pushButton_16, SIGNAL(clicked()), this, SLOT(Tsyfry()));

    connect(ui->pushButton_11, SIGNAL(clicked()), this, SLOT(Tsyfry()));
    connect(ui->pushButton_12, SIGNAL(clicked()), this, SLOT(Tsyfry()));
    connect(ui->pushButton_13, SIGNAL(clicked()), this, SLOT(Tsyfry()));

    connect(ui->pushButton_8, SIGNAL(clicked()), this, SLOT(Tsyfry()));
    connect(ui->pushButton_9, SIGNAL(clicked()), this, SLOT(Tsyfry()));
    connect(ui->pushButton_10, SIGNAL(clicked()), this, SLOT(Tsyfry()));
...
void MainWindow::Tsyfry() {
    try {
        QPushButton* button = (QPushButton*) qApp->focusWidget();
        if (button != nullptr && selectedLineEdit != nullptr) {
            if (button->text() == "<-")
                selectedLineEdit->setText(DeleteLastSymbol(selectedLineEdit->text()));
            else
                selectedLineEdit->setText(selectedLineEdit->text() + button->text());
...
QString MainWindow::DeleteLastSymbol(QString zhertva) {
    int length = zhertva.length() - 1;
    QString result = "";
